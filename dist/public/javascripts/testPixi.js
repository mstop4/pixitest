...
PIXI.loader.add("../images/bunny.jpg").add({
  name: "kitty",
...
function setup() {
  ...
  sprBunny = new PIXI.Sprite(PIXI.loader.resources["../images/bunny.jpg"].texture);
  sprKitty = new PIXI.Sprite(PIXI.loader.resources.kitty.texture);
